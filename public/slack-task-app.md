...
![1.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/7ff2e725-72c0-4202-9077-6ffbe3d4a607.png)

新規ワークフロー作成画面で「イベントを選択」をクリックします。

![slack-workflow-create.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/3c0da2c7-65a8-4278-8424-8f5711fc34f8.png)

表示されるイベント一覧から「Slack内のリンクから」を選択し、「続行する」をクリックします。

![2.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/01241a2d-7ee3-4829-b193-0902eca18aa7.png)

![3.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/95bb9e8a-d010-41ac-a3ca-964429ff8b18.png)

次に「ステップを追加する」をクリックし、「情報をフォームで収集する」を選択します。

![4.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/e846c71b-8771-4513-8f58-931aeac1ee1e.png)
...
![6.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/11c40bff-1f37-4a56-b6c2-6cc232bd45dd.png)

フォーム全体の設定は、次のようになります。

![9.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/a8bea9e3-e0c3-4acc-9c5c-dace639f95c2.png)

設定が完了したら、Googleスプレッドシートとの連携を行います。

その後、「次へ」→「保存する」を選択してください。

![10.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/01795073-131c-4985-9ca8-a77a9e2c16bc.png)

最後に、作成したワークフローを公開します。
これでSlack側の設定は完了です。

![13.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/10a3068d-a947-47f2-8944-7c164a155717.png)
...
![15.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/d292c9ae-c24e-4116-b89e-54b3513ec0be.png)
...
![17.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4142158/9a6c4c45-4373-4bb3-97ec-22f684886707.png)
